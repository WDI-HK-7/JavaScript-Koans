...
test("hasOwnProperty", function() {
    ...
    equal(2, keys.length, 'how many elements are in the keys array?'); //because of B.prototype = new A()
...
test("constructor property", function () {
    ...
    equal("", a.constructor.name, "what is the name of a's constructor?"); //see above A() is an anonymous function
