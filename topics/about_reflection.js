...
test("hasOwnProperty", function() {
    ...
    deepEqual([propertyName, ""], keys, 'what are the properties of the array?');
    ...
    equal(0, ownKeys.length, 'how many elements are in the ownKeys array?');
    deepEqual([""], ownKeys, 'what are the own properties of the array?');
});
