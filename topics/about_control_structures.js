...
test("switch default case", function() {
    ...
    equal("Merry", result, 'what is the value of result?'); //note: even if the case given doesn't match anything, if there is a default case, the default case will overrride the original variable.
});

test("null coalescing", function() {
    var result = null || "a value";
    equal("a value", result, 'what is the value of result?');
}); //null is falsey, so auto show second answer?
